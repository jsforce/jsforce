...
export class Logger {
  ...
  constructor(moduleName: string, logLevelConfig: LogLevelConfig = globalLogLevelConfig) {
    this._moduleName = moduleName;
    this._logLevel =
      typeof logLevelConfig === 'number' ? logLevelConfig :
      typeof logLevelConfig === 'string' ? (LogLevels[logLevelConfig] || LogLevels.NONE) :
