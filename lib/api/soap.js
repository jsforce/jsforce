...
/**
 * Call custom SOAP API endpoint.
 * @param {String} className The name of the Apex class containing the referenced
 * webservice static method
 * @param {String} method The name of the webservice static method to be invoked
 * @param {Object} message An object containing the parameters for the webservice
 * method, with actual parameter names as keys
 * @param {Object} [schema]
 * @param {Function} [callback]
 */
SoapApi.prototype.invokeWebService = function(className, method, message, schema, callback) {
  if (className.indexOf('.') >= 0) {
    className = className.replace(/\./g, '/');
  }
  var soapEndpoint = new SOAP(this._conn, {
    xmlns: "http://soap.sforce.com/schemas/class/" + className,
    endpointUrl: this._conn.instanceUrl + "/services/Soap/class/" + className
  });
