 ...
 * @private
 */
SoapApi.prototype._invoke = function(method, message, schema, callback, customHeaders) {
  var soapEndpoint = new SOAP(this._conn, {
    xmlns: "urn:partner.soap.sforce.com",
    endpointUrl: this._conn.instanceUrl + "/services/Soap/u/" + this._conn.version
  });
  return soapEndpoint.invoke(method, message, { result: schema }, null, customHeaders).then(function(res) {
    return res.result;
  }).thenCall(callback);
};
 ...
 * @param {Object} [customHeaders] - Custom SOAP Headers
 * @returns {Promise.<SoapApi~SaveResult>}
 */
SoapApi.prototype.create = function(sObjects, callback, customHeaders) {
  ...
  return this._invoke("create", args, schema, callback, customHeaders);
};
 ...
 * @returns {Promise.<SoapApi~SaveResult>}
 */
SoapApi.prototype.update = function(sObjects, callback, customHeaders) {
  var schema = _.isArray(sObjects) ? [ Schemas.SaveResult ] : Schemas.SaveResult;
  var args = {
    '@xmlns' : 'urn:partner.soap.sforce.com',
    '@xmlns:ns1' : 'sobject.partner.soap.sforce.com',
  ...
  return this._invoke("update", args, schema, callback, customHeaders);
};
 ...
 */
SoapApi.prototype.upsert = function(externalIdFieldName, sObjects, callback, customHeaders) {
  ...
  return this._invoke("upsert", args, schema, callback, customHeaders);
};
 ...
 */
SoapApi.prototype.delete = function(ids, callback, customHeaders) {
  ...
  return this._invoke("delete", args, schema, callback, customHeaders);
};
