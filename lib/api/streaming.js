...
Topic.prototype.subscribe = function(listener) {
  return this._streaming.subscribe(this.name, listener, "pushTopic");
};
...
Topic.prototype.unsubscribe = function(listener) {
  this._streaming.unsubscribe(this.name, listener, "pushTopic");
  return this;
};
...
PlatformEvent.prototype.subscribe = function(listener) {
  return this._streaming.subscribe(this.name, listener, "platformEvent");
};
...
PlatformEvent.prototype.unsubscribe = function(listener) {
  this._streaming.unsubscribe(this.name, listener, "platformEvent");
  return this;
};
...
Channel.prototype.subscribe = function(listener) {
  return this._streaming.subscribe(this._name, listener, "channel");
};

Channel.prototype.unsubscribe = function(listener) {
  this._streaming.unsubscribe(this._name, listener, "channel");
  return this;
};
 ...
 * @returns {Subscription} - Faye subscription object
 */
Streaming.prototype.subscribe = function(name, listener, clientType = "") {
  ...
  if (clientType != "") {
    ...
    if (clientType === "pushTopic")
      ...
      dir = "/event/";
    else if (clientType === "channel")
      dir = "";
    channelName = dir + name;
  }
 ...
 * @returns {Streaming}
 */
Streaming.prototype.unsubscribe = function(name, listener, clientType = "") {
  var channelName = name.indexOf('/') === 0 ? name : '/topic/' + name;
  if (clientType != "") {
    var dir;
    if (clientType === "pushTopic")
