...
/**
 * Implement finally method from Promise<T>
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/finally
 * 
 * @method Metadata~AsyncResultLocator#finally
 */
Request.prototype.finally = function(onFinally) {
  return this.promise().finally(onFinally);
};

/**
 * Implement catch method from Promise<T>
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/catch
 * 
 * @method Metadata~AsyncResultLocator#catch
 */
Request.prototype.catch = function(onReject) {
