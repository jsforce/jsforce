 ...
 *
 */
module.exports.toCSV = function(records, options) {
  options = options || {};
  var _headers = {};
  ...
  _.forEach(records, function(record) {
    for (var key in record) {
      ...
      if (record.hasOwnProperty(key) && typeof value !== 'object') {
        _headers[key] = true;
      }
    }
  });

  var headers = _.keys(_headers);
 ...
 *
 */
module.exports.parseCSV = function(str) {
