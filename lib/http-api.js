...
HttpApi.prototype.request = function(request, callback) {
  ...
  return this._transport.httpRequest(request).then(function(response) {
    ...
    if (self.isSessionExpired(response, request) && refreshDelegate) {
 ...
 * @protected
 */
HttpApi.prototype.isSessionExpired = function(response, request) {
  return response.statusCode === 401 || (response.statusCode === 403 && request.url.indexOf('login') > -1);
};
