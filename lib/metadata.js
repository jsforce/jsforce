...
Metadata.prototype.createSync = function(type, metadata, callback) {
  ...
  var isArray = _.isArray(metadata);
  metadata = isArray ? _.map(metadata, convert) : convert(metadata);
  return this._invoke("createMetadata", { metadata: metadata }).thenCall(callback);
};
 ...
 * @returns {Promise.<Array.<Metadata~ReadResult|Array.<Metadata~ReadResult>>>}
 */
...
Metadata.prototype.updateSync = function(type, metadata, callback) {
  ...
  var isArray = _.isArray(metadata);
  metadata = isArray ? _.map(metadata, convert) : convert(metadata);
  return this._invoke("updateMetadata", { metadata: metadata }).thenCall(callback);
};
...
Metadata.prototype.deleteSync = function(type, fullNames, callback) {
  return this._invoke("deleteMetadata", { type: type, fullNames: fullNames }).thenCall(callback);
};
...
Metadata.prototype.rename = function(type, oldFullName, newFullName, callback) {
  return this._invoke("renameMetadata", { type: type, oldFullName: oldFullName, newFullName: newFullName }).thenCall(callback);
};
