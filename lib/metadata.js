 ...
 * @prop {String} type - The type of the metadata
 ...
 */
Metadata.prototype.create = function(metadata, callback) {
 ...
 * @returns {Metadata.AsyncResultLocator}
 */
Metadata.prototype.update = function(updateMetadata, callback) {
  var convert = function(umd) {
    umd.metadata["@xsi:type"] = umd.metadata.type;
