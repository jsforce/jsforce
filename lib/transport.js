 ...
 * @protected
 */
var Transport = module.exports = function(requestLibOptions) {
  this._requestLibOptions = requestLibOptions || {};
};
...
Transport.prototype.httpRequest = function(params, callback) {
  ...
  var httpRequestParams = Object.assign(this._requestLibOptions, params);
  var createRequest = function() {
    if (!req) {
      req = httpRequest(httpRequestParams, function(err, response) {
        if (err) {
          deferred.reject(err);
        } else {
