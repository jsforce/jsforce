...
var SObject = module.exports = function(conn, type) {
  ...
  this.describe$ = conn._cache.makeCacheable(this.describe, this, cacheOptions);
  this.describe = conn._cache.makeResponseCacheable(this.describe, this, cacheOptions);
};
 ...
 */
SObject.prototype.select = function(fields, options, callback) {
