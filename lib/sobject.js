 ...
 * @param {Id} [recordTypeId] - The recordTypeId of the SObject.
 * @param {Callback.<LayoutInfo>} [callback] - Callback function
 * @returns {Promise.<LayoutInfo>}
 */
SObject.prototype.layouts = function(layoutName, recordTypeId, callback) {
  if (typeof layoutName === 'function') {
    callback = layoutName;
    layoutName = null;
  } else if(typeof recordTypeId === 'function'){
    callback = recordTypeId;
    recordTypeId = null;
  }
  var url = "/sobjects/" + this.type + "/describe/" + (layoutName ? "namedLayouts/"+layoutName : (recordTypeId ? "layouts/" + recordTypeId : "layouts"));
