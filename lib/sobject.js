...
/**
 * Retrieve specified record by external id
 *
 ...
 * @returns {Promise.<Record|Array.<Record>>}
 */
SObject.prototype.retrieveByExtId = function(extIdField, id, options, callback) {
  if (typeof options === 'function') {
    callback = options;
    options = {};
  }
  return this._conn.retrieveByExtId(this.type, extIdField, id, options, callback);
};
