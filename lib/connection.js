 ...
 *
 * Setting revoke to true will revoke API access
 *
 * @param {Callback.<undefined>} [callback] - Callback function
 * @returns {Promise.<undefined>}
 */
Connection.prototype.logout = function(callback, revoke = false) {
  if (this._sessionType === "oauth2") {
    return this.logoutByOAuth2(callback, revoke);
  } else {
    return this.logoutBySoap(callback, revoke);
  }
};
 ...
 * @returns {Promise.<undefined>}
 */
Connection.prototype.logoutByOAuth2 = function(callback, revoke = false) {
  var self = this;
  var logger = this._logger;
 ...
 * @returns {Promise.<undefined>}
 */
Connection.prototype.logoutBySoap = function(callback, revoke = false) {
  var self = this;
  var logger = this._logger;
