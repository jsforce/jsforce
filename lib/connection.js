...
var Connection = module.exports = function(options) {
  ...
  this.describe$ = this._cache.makeCacheable(this.describe, this, cacheOptions);
  this.describe = this._cache.makeResponseCacheable(this.describe, this, cacheOptions);

  cacheOptions = { key: 'describeGlobal' };
  this.describeGlobal$ = this._cache.makeCacheable(this.describeGlobal, this, cacheOptions);
  this.describeGlobal = this._cache.makeResponseCacheable(this.describeGlobal, this, cacheOptions);
...
Connection.prototype.initialize = function(options) {
  ...
  this.sobjects = {};
  this._cache.get('describeGlobal').on('value', _.bind(function(res) {
    if (res.result) {
...
Connection.prototype.loginBySoap = function(username, password, callback) {
  ...
  request({
    ...
    if (response.statusCode >= 400) {
      ...
      callback({ message : faultstring || response.body });
      return;
    }
