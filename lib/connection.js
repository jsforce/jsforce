 ...
 */
Connection.prototype.logout = function(revoke = false, callback) {
 ...
 * @returns {Promise.<undefined>}
 */
Connection.prototype.logoutByOAuth2 = function(revoke = false, callback) {
  var self = this;
  var logger = this._logger;
 ...
 * @returns {Promise.<undefined>}
 */
Connection.prototype.logoutBySoap = function(revoke = false, callback) {
  var self = this;
  var logger = this._logger;
