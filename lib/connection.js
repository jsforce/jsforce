 ...
 * @param {String} [options.proxyUserName] - Optional: specify proxy user name if proxy server requires authentication.
 * @param {String} [options.proxyPassword] - Optional: specify proxy password if proxy server requires authentication.
...
var Connection = module.exports = function(options) {
  ...
  /** @private */
  if (options.proxyUrl) {
    this._transport = new Transport.ProxyTransport(options.proxyUrl, options.proxyUserName, options.proxyPassword);
