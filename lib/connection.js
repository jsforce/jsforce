 ...
 * @param {Object} [options.requestLibOptions] - Customize options to each HTTP request the underlying `requests` library makes. (https://github.com/request/request#requestoptions-callback)
 */
var Connection = module.exports = function(options) {
  ...
  if (options.proxyUrl) {
    ...
    this._transport = new Transport(options.requestLibOptions);
  }
